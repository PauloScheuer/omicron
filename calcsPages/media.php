    ...
    include '../commons/menu.php'; ?>
        ...
        <h1>Média</h1>
            ...
            <p>
                ...
                calculada através da soma de todos os termos dividido pelo número total deles. É recomendada para casos 
                em que os valores do conjunto de termos sejam próximos, sem grandes diferenças. 
            </p>
             </fieldset>
        </div>
        ...
        if(is_numeric($_GET['n1'])){
            ...
            $a=2;
             ...
             $somatudo= array_sum($array);
             $div= $somatudo/$c;
               echo "Fórmula da média: "
            . "<div lang='latex'>M_s=\dfrac{ S_n}{ n}</div><br>"
             . "Nesse caso, temos:"
             ."<div lang='latex'>M_s=\dfrac{ $tudo}{ $c}</div><br>"
                  ."<div lang='latex'>M_s=$div</div><br>";
            }
        }else{
        ...
        ?>
           ...
           <?php
            ...
            lerPerg(20,"media.php");
            if (!empty($_GET['titu'])) {
            $titu = $_GET['titu'];
            $texto = $_GET['texto'];
            $conteudo = $_GET['conteudo'];
            $data=$_GET['data'];
            InserirPerg($titu, $texto, $conteudo, $data, "media.php");
            }
            ...
            if (!empty($_GET['txtr'])) {
                ...
                $resposta=$_GET['txtr'];
                $data=$_GET['data'];
                InserirResp($resposta, $pergunta, $data, "media.php");
            }
            ?>
            </fieldset>
            </div>
